...
export class MasterChef extends ethereum.SmartContract {
  ...
  pendingPickle(_pid: BigInt, _user: Address): BigInt {
    let result = super.call(
      "pendingPickle",
      "pendingPickle(uint256,address):(uint256)",
      [
  ...
  try_pendingPickle(_pid: BigInt, _user: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "pendingPickle",
      "pendingPickle(uint256,address):(uint256)",
      [
  ...
  pickle(): Address {
    let result = super.call("pickle", "pickle():(address)", []);

    return result[0].toAddress();
  }

  try_pickle(): ethereum.CallResult<Address> {
    let result = super.tryCall("pickle", "pickle():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  picklePerBlock(): BigInt {
    let result = super.call("picklePerBlock", "picklePerBlock():(uint256)", []);

    return result[0].toBigInt();
  }

  try_picklePerBlock(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "picklePerBlock",
      "picklePerBlock():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class SetPicklePerBlockCall extends ethereum.Call {
  get inputs(): SetPicklePerBlockCall__Inputs {
    return new SetPicklePerBlockCall__Inputs(this);
  }

  get outputs(): SetPicklePerBlockCall__Outputs {
    return new SetPicklePerBlockCall__Outputs(this);
  }
}

export class SetPicklePerBlockCall__Inputs {
  _call: SetPicklePerBlockCall;

  constructor(call: SetPicklePerBlockCall) {
    this._call = call;
  }
...
export class SetPicklePerBlockCall__Outputs {
  _call: SetPicklePerBlockCall;
